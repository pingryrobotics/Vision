...
=======
	...
	with cond:
		notified[0] = True
		cond.notify()
>>>>>>> a095538056c9c2c35402a8f40916acfba684a9a1
...
=======
		blurOut = cv2.blur(threshOut, (ksize,ksize))
		im2, cnts, hierarchy = cv2.findContours(blurOut, mode=mode, method=method)
		contours = []
		for contour in cnts:
...
=======
			upperMidpoint = [(points[2][0]+points[3][0])/2,(points[2][1]+points[3][1])/2]
			lowerMidpoint = [(points[0][0]+points[1][0])/2,(points[0][1]+points[1][1])/2]
			y = (upperMidpoint[1]-lowerMidpoint[1])
			x = (upperMidpoint[0]-lowerMidpoint[0])
...
>>>>>>> a095538056c9c2c35402a8f40916acfba684a9a1
			...
			cv2.line(img=frame,pt1=(int(upperMidpoint[0]),int(upperMidpoint[1])),pt2=(int(lowerMidpoint[0]),int(lowerMidpoint[1])),color=(255,0,0),thickness=4,lineType=8)
