...
defaults = [65.0,140.0,200.0,255.0,50.0,255.0]
...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [self.nt.getNumber("hueMin",defaults[0]),self.nt.getNumber("hueMax",defaults[1])]
        self.__hsv_threshold_saturation = [self.nt.getNumber("satMin",defaults[2]),self.nt.getNumber("satMax",defaults[3])]
        self.__hsv_threshold_value = [self.nt.getNumber("valMin",defaults[4]),self.nt.getNumber("valMax",defaults[5])]
    ...
    def process(self, source0):
        ...
        self.nt.putNumber("contoursFound",len(self.__filter_contours_contours))
